# 📁 04-Proyecto-Final ➔ Proyectos-Estudiantes

> **Ubicación en Repositorio:** `04-proyecto-final/proyectos-estudiantes`  
...
```mermaid
flowchart LR
    COMP["📦 Componente<br/>proyectos-estudiantes"] --> SYS["⚙️ Sistema wisrovi-python<br/>Infraestructura & Recursos"]
