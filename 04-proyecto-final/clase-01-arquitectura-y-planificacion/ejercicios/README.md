...
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_04/test_clase_01_arquitectura_y_planificacion.py`](../../tests/curso_04/test_clase_01_arquitectura_y_planificacion.py)
