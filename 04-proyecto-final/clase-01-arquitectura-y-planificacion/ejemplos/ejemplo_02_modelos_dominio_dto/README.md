# 📖 02 Modelos Dominio Dto

> **Clase:** Clase 01: Arquitectura de Software y Planificación del Proyecto  
> **Ubicación:** `04-proyecto-final/clase-01-arquitectura-y-planificacion/ejemplos/ejemplo_02_modelos_dominio_dto`  
...
```bash
python 04-proyecto-final/clase-01-arquitectura-y-planificacion/ejemplos/ejemplo_02_modelos_dominio_dto/main.py
```
