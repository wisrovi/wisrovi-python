# 📓 Cuaderno Interactivo: Clase 01: Arquitectura de Software y Planificación del Proyecto

> **Curso:** 04-proyecto-final  
> **Archivo:** [`clase-01-arquitectura-y-planificacion.ipynb`](clase-01-arquitectura-y-planificacion.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-01-arquitectura-y-planificacion.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-01-arquitectura-y-planificacion.ipynb`](clase-01-arquitectura-y-planificacion.ipynb) directamente en Visual Studio Code.
