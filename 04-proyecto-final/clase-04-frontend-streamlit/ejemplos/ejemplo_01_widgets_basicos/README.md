...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Widgets Basicos)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-04-frontend-streamlit/ejemplos/ejemplo_01_widgets_basicos/main.py
```
