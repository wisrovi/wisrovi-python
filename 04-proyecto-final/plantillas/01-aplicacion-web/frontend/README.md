# 📁 04-Proyecto-Final ➔ Plantillas ➔ 01-Aplicacion-Web ➔ Frontend

> **Ubicación en Repositorio:** `04-proyecto-final/plantillas/01-aplicacion-web/frontend`  
...
```mermaid
flowchart LR
    COMP["📦 Componente<br/>frontend"] --> SYS["⚙️ Sistema wisrovi-python<br/>Infraestructura & Recursos"]
