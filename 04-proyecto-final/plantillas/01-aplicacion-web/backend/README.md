# 📁 04-Proyecto-Final ➔ Plantillas ➔ 01-Aplicacion-Web ➔ Backend

> **Ubicación en Repositorio:** `04-proyecto-final/plantillas/01-aplicacion-web/backend`  
...
```mermaid
flowchart LR
    COMP["📦 Componente<br/>backend"] --> SYS["⚙️ Sistema wisrovi-python<br/>Infraestructura & Recursos"]
