# 📁 04-Proyecto-Final ➔ Plantillas

> **Ubicación en Repositorio:** `04-proyecto-final/plantillas`  
...
```mermaid
flowchart LR
    COMP["📦 Componente<br/>plantillas"] --> SYS["⚙️ Sistema wisrovi-python<br/>Infraestructura & Recursos"]
