# 📓 Cuaderno Interactivo: Clase 03: Persistencia de Datos: Modelado SQL y Transacciones ACID

> **Curso:** 04-proyecto-final  
> **Archivo:** [`clase-03-persistencia-sql-transacciones.ipynb`](clase-03-persistencia-sql-transacciones.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-03-persistencia-sql-transacciones.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-03-persistencia-sql-transacciones.ipynb`](clase-03-persistencia-sql-transacciones.ipynb) directamente en Visual Studio Code.
