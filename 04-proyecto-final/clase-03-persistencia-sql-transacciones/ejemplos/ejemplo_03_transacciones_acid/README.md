# 📖 03 Transacciones Acid

> **Clase:** Clase 03: Persistencia de Datos: Modelado SQL y Transacciones ACID  
> **Ubicación:** `04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos/ejemplo_03_transacciones_acid`  
...
```bash
python 04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos/ejemplo_03_transacciones_acid/main.py
```
