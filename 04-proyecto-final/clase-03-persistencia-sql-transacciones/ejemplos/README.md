...
> **Ubicación:** `04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos`  
...
| :--- | :--- | :---: |
| [`ejemplo_01_ddl_sqlite/`](ejemplo_01_ddl_sqlite/) | Demostración paso a paso | [`main.py`](ejemplo_01_ddl_sqlite/main.py) |
| [`ejemplo_02_consultas_parametrizadas/`](ejemplo_02_consultas_parametrizadas/) | Demostración paso a paso | [`main.py`](ejemplo_02_consultas_parametrizadas/main.py) |
| [`ejemplo_03_transacciones_acid/`](ejemplo_03_transacciones_acid/) | Demostración paso a paso | [`main.py`](ejemplo_03_transacciones_acid/main.py) |
| [`ejemplo_04_repositorio_crud/`](ejemplo_04_repositorio_crud/) | Demostración paso a paso | [`main.py`](ejemplo_04_repositorio_crud/main.py) |
...
```bash
python 04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos/<carpeta_ejemplo>/main.py
```
