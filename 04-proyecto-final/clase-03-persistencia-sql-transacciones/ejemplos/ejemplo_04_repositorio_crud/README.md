...
> **Ubicación:** `04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos/ejemplo_04_repositorio_crud`  
...
```bash
python 04-proyecto-final/clase-03-persistencia-sql-transacciones/ejemplos/ejemplo_04_repositorio_crud/main.py
```
