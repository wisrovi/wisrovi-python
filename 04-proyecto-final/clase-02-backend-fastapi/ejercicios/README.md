# 🏋️ Reto Práctico: Clase 02: Desarrollo del Backend: APIs RESTful con FastAPI

<div align="center">

**Curso 4: Taller Práctico & Proyecto Final Integrador** &bull; **Semana CLASE 02**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_04/test_clase_02_backend_fastapi.py`](../../tests/curso_04/test_clase_02_backend_fastapi.py)
