...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Inyeccion Depends)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-02-backend-fastapi/ejemplos/ejemplo_04_inyeccion_depends/main.py
```
