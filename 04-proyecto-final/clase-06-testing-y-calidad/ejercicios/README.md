...
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_04/test_clase_06_testing_y_calidad.py`](../../tests/curso_04/test_clase_06_testing_y_calidad.py)
