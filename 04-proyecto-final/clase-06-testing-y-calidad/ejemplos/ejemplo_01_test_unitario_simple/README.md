...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Test Unitario Simple)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-06-testing-y-calidad/ejemplos/ejemplo_01_test_unitario_simple/main.py
```
