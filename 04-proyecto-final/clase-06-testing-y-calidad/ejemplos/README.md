...
> **Ubicación:** `04-proyecto-final/clase-06-testing-y-calidad/ejemplos`  
...
| :--- | :--- | :---: |
| [`ejemplo_01_test_unitario_simple/`](ejemplo_01_test_unitario_simple/) | Demostración paso a paso | [`main.py`](ejemplo_01_test_unitario_simple/main.py) |
| [`ejemplo_02_pytest_fixtures/`](ejemplo_02_pytest_fixtures/) | Demostración paso a paso | [`main.py`](ejemplo_02_pytest_fixtures/main.py) |
| [`ejemplo_03_mocking_servicios/`](ejemplo_03_mocking_servicios/) | Demostración paso a paso | [`main.py`](ejemplo_03_mocking_servicios/main.py) |
| [`ejemplo_04_testclient_fastapi/`](ejemplo_04_testclient_fastapi/) | Demostración paso a paso | [`main.py`](ejemplo_04_testclient_fastapi/main.py) |
...
```bash
python 04-proyecto-final/clase-06-testing-y-calidad/ejemplos/<carpeta_ejemplo>/main.py
```
