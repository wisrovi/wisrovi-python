# 📓 Cuaderno Interactivo: Clase 08: Despliegue en la Nube, CI/CD y Portafolio Final

> **Curso:** 04-proyecto-final  
> **Archivo:** [`clase-08-despliegue-cicd-portafolio.ipynb`](clase-08-despliegue-cicd-portafolio.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-08-despliegue-cicd-portafolio.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-08-despliegue-cicd-portafolio.ipynb`](clase-08-despliegue-cicd-portafolio.ipynb) directamente en Visual Studio Code.
