# 🏋️ Reto Práctico: Clase 08: Despliegue en la Nube, CI/CD y Portafolio Final

<div align="center">

**Curso 4: Taller Práctico & Proyecto Final Integrador** &bull; **Semana CLASE 08**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_04/test_clase_08_despliegue_cicd_portafolio.py`](../../tests/curso_04/test_clase_08_despliegue_cicd_portafolio.py)
