...
Plantilla de Pull Request para Graduados.
...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Plantilla Pr Graduacion)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-08-despliegue-cicd-portafolio/ejemplos/ejemplo_04_plantilla_pr_graduacion/main.py
```
