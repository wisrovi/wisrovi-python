# 📖 03 Config Produccion

> **Clase:** Clase 08: Despliegue en la Nube, CI/CD y Portafolio Final  
> **Ubicación:** `04-proyecto-final/clase-08-despliegue-cicd-portafolio/ejemplos/ejemplo_03_config_produccion`  
...
```bash
python 04-proyecto-final/clase-08-despliegue-cicd-portafolio/ejemplos/ejemplo_03_config_produccion/main.py
```
