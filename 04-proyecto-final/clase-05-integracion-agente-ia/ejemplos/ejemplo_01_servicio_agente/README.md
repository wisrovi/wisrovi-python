...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Servicio Agente)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-05-integracion-agente-ia/ejemplos/ejemplo_01_servicio_agente/main.py
```
