# 📓 Cuaderno Interactivo: Clase 05: Integración del Motor de IA y Agentes en la App

> **Curso:** 04-proyecto-final  
> **Archivo:** [`clase-05-integracion-agente-ia.ipynb`](clase-05-integracion-agente-ia.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-05-integracion-agente-ia.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-05-integracion-agente-ia.ipynb`](clase-05-integracion-agente-ia.ipynb) directamente en Visual Studio Code.
