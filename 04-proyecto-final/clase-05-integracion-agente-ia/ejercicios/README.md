# 🏋️ Reto Práctico: Clase 05: Integración del Motor de IA y Agentes en la App

<div align="center">

**Curso 4: Taller Práctico & Proyecto Final Integrador** &bull; **Semana CLASE 05**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_04/test_clase_05_integracion_agente_ia.py`](../../tests/curso_04/test_clase_05_integracion_agente_ia.py)
