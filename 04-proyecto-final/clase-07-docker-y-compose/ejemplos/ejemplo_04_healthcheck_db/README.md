...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Healthcheck Db)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 04-proyecto-final/clase-07-docker-y-compose/ejemplos/ejemplo_04_healthcheck_db/main.py
```
