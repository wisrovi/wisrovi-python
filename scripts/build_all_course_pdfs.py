...
CLASSES_METADATA = [
...

    {
        ...
        "course_name": "Curso 1: Fundamentos Básicos de Python",
        "course_num": "1 (Principiantes)",
        "class_title": "Clase 02: Variables y Tipos de Datos",
        "class_code": "Clase 02",
        "level": "Principiante Absoluto",
        "metaphor": "El Almacén, el Collar de Letras y el Micrófono",
        "description": "Dominio absoluto de la memoria en Python: tipos primitivos (str, int, float, bool), conversión de tipos (casting) e interacción dinámica con input().",
        "diagram_type": "flow",
        "obj_conceptual": "Comprender la diferencia fundamental entre tipos numéricos y texto, y cómo Python asigna memoria dinámicamente.",
        "obj_practical": "Construir programas interactivos que soliciten datos al usuario, realicen conversiones numéricas y devuelvan mensajes formateados.",
        "p4_title": "El Almacén de Datos y la Memoria de la Computadora",
        "p4_intro": "Una variable es un identificador que apunta a una ubicación de memoria donde reside un valor con un tipo de dato específico.",
        "p4_metaphor_desc": "Imagina un almacén con cajas etiquetadas. Una caja pequeña guarda números enteros (int), una caja de precisión con decimales guarda números reales (float), una caja larga guarda un collar de letras enhebradas (str) y un interruptor de encendido/apagado representa un valor booleano (bool).",
        "p4_theory_1": "Python utiliza tipado dinámico: no necesitas declarar el tipo de antemano, el intérprete lo infiere en tiempo de asignación.",
        "p4_theory_2": "La función input() SIEMPRE devuelve una cadena de texto (str). Para operar matemáticamente con ella es imperativo hacer casting mediante int() o float().",
        "p4_golden_rule": "Nunca sumes texto con números sin convertir; '10' + 5 genera TypeError, pero int('10') + 5 produce 15.",
        "p5_title": "Ciclo de Conversión y Entrada de Datos (Casting)",
        "p5_desc": "Flujo de recepción de datos por teclado, validación de tipo y operación aritmética en memoria.",
        "p5_step1_action": "La función input() captura la entrada del teclado como string.",
        "p5_step1_state": "Buffer de entrada -> '25' (str)",
        "p5_step2_action": "La función int() o float() transforma los caracteres en número binario.",
        "p5_step2_state": "Casting -> 25 (int)",
        "p5_step3_action": "La ALU del procesador realiza la operación matemática solicitada.",
        "p5_step3_state": "25 * 2 = 50 en CPU",
        "p5_step4_action": "f-string formatea el resultado y lo proyecta en la salida estándar.",
        "p5_step4_state": "Render en pantalla",
        "p5_mental_tip": "Siempre valida y castea los datos en la frontera de entrada del programa antes de procesarlos en la lógica de negocio.",
        "p6_title": "Calculadora de Ahorro con Conversión de Tipos",
        "p6_desc": "Programa completo que solicita entradas, convierte tipos de datos y utiliza f-strings modernas:",
        "p6_code": '<span class="cm"># Entrada de datos con conversión directa</span>\nnombre_usuario: <span class="bi">str</span> = <span class="bi">input</span>(<span class="st">"Ingresa tu nombre: "</span>)\ningreso_mensual: <span class="bi">float</span> = <span class="bi">float</span>(<span class="bi">input</span>(<span class="st">"Ingreso mensual ($): "</span>))\nporcentaje_ahorro: <span class="bi">float</span> = <span class="bi">float</span>(<span class="bi">input</span>(<span class="st">"Porcentaje a ahorrar (%): "</span>))\n\n<span class="cm"># Cálculo matemático</span>\nmonto_ahorro: <span class="bi">float</span> = ingreso_mensual * (porcentaje_ahorro / <span class="nu">100.0</span>)\nes_meta_alta: <span class="bi">bool</span> = monto_ahorro >= <span class="nu">500.0</span>\n\n<span class="cm"># Salida formateada con f-strings</span>\n<span class="bi">print</span>(<span class="st">f"\\n--- Reporte Financiero de {nombre_usuario} ---"</span>)\n<span class="bi">print</span>(<span class="st">f"Ahorro estimado: ${monto_ahorro:,.2f}"</span>)\n<span class="bi">print</span>(<span class="st">f"¿Es un ahorro significativo?: {es_meta_alta}"</span>)',
        "p6_code_analysis": "Se declaran variables con anotaciones de tipo, se realiza casting explícito con float() y se formatea el número a dos decimales con ${monto_ahorro:,.2f}.",
        "p7_title": "Trampas Clásicas con Variables y Casting",
        "p7_intro": "Errores comunes de principiantes al trabajar con tipos de datos:",
        "p7_gotcha": "Intentar convertir una cadena con caracteres alfabéticos a int (ej: int('hola')), lo cual dispara un ValueError.",
        ...
        "p7_pro_tip": "Usa siempre f-strings (f'Texto {variable}') en lugar del operador + para concatenar texto con variables.",
        "p8_summary": "Dominas los 4 tipos primitivos esenciales de Python, la captura interactiva de datos y el formateo profesional.",
        "p8_achievement": "Capacidad para construir programas interactivos con entradas validadas y cálculos matemáticos precisos.",
        "p8_instructor_notes": "En la siguiente clase exploraremos el control de flujo condicional: cómo dotar a la computadora de capacidad de decisión.",
        "p9_challenge": "Crea un conversor de temperatura que solicite grados Celsius y devuelva Fahrenheit y Kelvin formateados a un decimal."
    },
