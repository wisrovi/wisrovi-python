# 📖 03 Recorrido Inorder

> **Clase:** Clase 06: Árboles Binarios de Búsqueda (BST) y Recorridos  
> **Ubicación:** `02-algoritmos-estructuras/clase-06-arboles-binarios-busqueda/ejemplos/ejemplo_03_recorrido_inorder`  
...
```bash
python 02-algoritmos-estructuras/clase-06-arboles-binarios-busqueda/ejemplos/ejemplo_03_recorrido_inorder/main.py
```
