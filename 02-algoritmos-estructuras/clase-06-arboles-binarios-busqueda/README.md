...
**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 06**  
*Nivel:* `Nivel 2 - Intermedio` &bull; *Metáfora Central:* **«Árboles como Organigramas Jerárquicos con Ramas Izquierda y Derecha»**
...
[![PDF Oficial](https://img.shields.io/badge/Manual-PDF%209%20Páginas-red.svg?logo=adobeacrobatreader&logoColor=white)](clase-06-arboles-binarios-busqueda.pdf)
...
*   **Competencia Conceptual:** Comprender el modelo mental de *«Árboles como Organigramas Jerárquicos con Ramas Izquierda y Derecha»* (Un árbol BST es como un árbol genealógico donde a la izquierda van los números menores y a la derecha los mayores.).
...
```mermaid
flowchart LR
    IN["📥 1. Datos de Entrada<br/>(Árboles como Organigramas Jerá...)"] --> ENG["⚙️ 2. Motor de Procesamiento<br/>Árboles Binarios de Búsqueda (BST) y Recorridos"]
...
```text
clase-06-arboles-binarios-busqueda/
├── 📄 clase-06-arboles-binarios-busqueda.pdf       # Manual técnico oficial de estudio (9 páginas)
...
│   ├── 📓 clase-06-arboles-binarios-busqueda.ipynb
...
> **Enunciado:** Escribe una función que calcule la altura máxima (profundidad) de un árbol binario.
