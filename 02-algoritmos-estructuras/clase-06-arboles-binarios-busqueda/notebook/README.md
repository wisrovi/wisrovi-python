# 📓 Cuaderno Interactivo: Clase 06: Árboles Binarios de Búsqueda (BST) y Recorridos

> **Curso:** 02-algoritmos-estructuras  
> **Archivo:** [`clase-06-arboles-binarios-busqueda.ipynb`](clase-06-arboles-binarios-busqueda.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 clase-06-arboles-binarios-busqueda.ipynb"] --> COLAB["☁️ Google Colab<br/>(1 Clic)"]
...
*   **En Local:** Abre [`clase-06-arboles-binarios-busqueda.ipynb`](clase-06-arboles-binarios-busqueda.ipynb) directamente en Visual Studio Code.
