# 🏋️ Reto Práctico: Clase 06: Árboles Binarios de Búsqueda (BST) y Recorridos

<div align="center">

**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 06**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_02/test_clase_06_arboles_binarios_busqueda.py`](../../tests/curso_02/test_clase_06_arboles_binarios_busqueda.py)
...
flowchart LR
    ...
    B --> C["🧪 3. Ejecutar Pytest<br/>pytest tests/curso_02/"]
