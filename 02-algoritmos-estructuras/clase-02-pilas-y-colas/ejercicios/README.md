# 🏋️ Reto Práctico: Clase 02: Pilas (Stacks) y Colas (Queues) con collections.deque

<div align="center">

**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 02**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_02/test_clase_02_pilas_y_colas.py`](../../tests/curso_02/test_clase_02_pilas_y_colas.py)
