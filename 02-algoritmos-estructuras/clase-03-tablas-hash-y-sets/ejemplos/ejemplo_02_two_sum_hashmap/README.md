...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Two Sum Hashmap)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 02-algoritmos-estructuras/clase-03-tablas-hash-y-sets/ejemplos/ejemplo_02_two_sum_hashmap/main.py
```
