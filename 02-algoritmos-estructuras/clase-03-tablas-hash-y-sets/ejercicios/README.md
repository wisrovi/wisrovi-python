# 🏋️ Reto Práctico: Clase 03: Tablas Hash y Conjuntos (Sets) para Búsqueda O(1)

<div align="center">

**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 03**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_02/test_clase_03_tablas_hash_y_sets.py`](../../tests/curso_02/test_clase_03_tablas_hash_y_sets.py)
