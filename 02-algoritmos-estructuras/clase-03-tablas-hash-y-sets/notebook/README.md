# 📓 Cuaderno Interactivo: Clase 03: Tablas Hash y Conjuntos (Sets) para Búsqueda O(1)

> **Curso:** 02-algoritmos-estructuras  
> **Archivo:** [`clase-03-tablas-hash-y-sets.ipynb`](clase-03-tablas-hash-y-sets.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-03-tablas-hash-y-sets.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-03-tablas-hash-y-sets.ipynb`](clase-03-tablas-hash-y-sets.ipynb) directamente en Visual Studio Code.
