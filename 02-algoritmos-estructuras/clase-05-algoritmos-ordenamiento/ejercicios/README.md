# 🏋️ Reto Práctico: Clase 05: Algoritmos de Ordenamiento: QuickSort y MergeSort

<div align="center">

**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 05**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_02/test_clase_05_algoritmos_ordenamiento.py`](../../tests/curso_02/test_clase_05_algoritmos_ordenamiento.py)
