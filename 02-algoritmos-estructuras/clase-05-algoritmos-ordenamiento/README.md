...
1. **💡 Modelo Mental:** QuickSort elige un elemento pivote y separa las cartas en dos montones: menores a la izquierda, mayores a la derecha.
...
```mermaid
flowchart LR
    M["💡 1. Modelo Mental<br/>«Ordenar Barajas de Cartas con ...»"] --> E["💻 2. Ejemplos Prácticos<br/>4 carpetas ejecutables"]
...
```mermaid
flowchart LR
    A["🎬 Entrada / Contexto<br/>(Ordenar Barajas de Cartas con Divide y Vencerás)"] --> B{"⚖️ Evaluación Lógica<br/>¿Condición / Regla?"}
    B -->|Rama Verdadera| C["⚙️ Transformación en Memoria<br/>QuickSort y MergeSort"]
...
*   📄 [`clase-05-algoritmos-ordenamiento.pdf`](clase-05-algoritmos-ordenamiento.pdf): Manual técnico oficial en PDF (9 páginas de estudio).
