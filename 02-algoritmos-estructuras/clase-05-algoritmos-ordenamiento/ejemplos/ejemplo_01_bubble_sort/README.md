...
> **Ubicación:** `02-algoritmos-estructuras/clase-05-algoritmos-ordenamiento/ejemplos/ejemplo_01_bubble_sort`  
...
```bash
python 02-algoritmos-estructuras/clase-05-algoritmos-ordenamiento/ejemplos/ejemplo_01_bubble_sort/main.py
```
