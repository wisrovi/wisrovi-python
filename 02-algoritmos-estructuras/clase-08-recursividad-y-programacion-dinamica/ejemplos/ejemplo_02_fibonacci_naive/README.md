...
> **Ubicación:** `02-algoritmos-estructuras/clase-08-recursividad-y-programacion-dinamica/ejemplos/ejemplo_02_fibonacci_naive`  
...
```bash
python 02-algoritmos-estructuras/clase-08-recursividad-y-programacion-dinamica/ejemplos/ejemplo_02_fibonacci_naive/main.py
```
