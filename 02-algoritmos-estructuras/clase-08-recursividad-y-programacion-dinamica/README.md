...
1. **💡 Modelo Mental:** Si te pregunto cuánto es 1+1+1+1, cuentas 4. Si añado otro +1, sabes que es 5 porque recordaste el 4 anterior.
...
```mermaid
flowchart LR
    M["💡 1. Modelo Mental<br/>«Programación Dinámica como Rec...»"] --> E["💻 2. Ejemplos Prácticos<br/>4 carpetas ejecutables"]
...
```mermaid
flowchart LR
    A["🎬 Entrada / Contexto<br/>(Programación Dinámica como Recordar el Pasado para no Resolverlo Dos Veces)"] --> B{"⚖️ Evaluación Lógica<br/>¿Condición / Regla?"}
    B -->|Rama Verdadera| C["⚙️ Transformación en Memoria<br/>Recursividad y Programación Dinámica con Memoización"]
...
*   📄 [`clase-08-recursividad-y-programacion-dinamica.pdf`](clase-08-recursividad-y-programacion-dinamica.pdf): Manual técnico oficial en PDF (9 páginas de estudio).
