# 📓 Cuaderno Interactivo: Clase 07: Grafos, Matrices de Adyacencia y Recorridos BFS/DFS

> **Curso:** 02-algoritmos-estructuras  
> **Archivo:** [`clase-07-grafos-y-recorridos.ipynb`](clase-07-grafos-y-recorridos.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-07-grafos-y-recorridos.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-07-grafos-y-recorridos.ipynb`](clase-07-grafos-y-recorridos.ipynb) directamente en Visual Studio Code.
