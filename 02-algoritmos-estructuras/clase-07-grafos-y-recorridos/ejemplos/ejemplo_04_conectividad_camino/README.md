# 📖 04 Conectividad Camino

> **Clase:** Clase 07: Grafos, Matrices de Adyacencia y Recorridos BFS/DFS  
> **Ubicación:** `02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_04_conectividad_camino`  
...
```bash
python 02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_04_conectividad_camino/main.py
```
