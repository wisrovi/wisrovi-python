...
> **Ubicación:** `02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_03_recorrido_dfs`  
...
```bash
python 02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_03_recorrido_dfs/main.py
```
