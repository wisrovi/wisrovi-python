...
> **Ubicación:** `02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_02_recorrido_bfs`  
...
```bash
python 02-algoritmos-estructuras/clase-07-grafos-y-recorridos/ejemplos/ejemplo_02_recorrido_bfs/main.py
```
