# 📓 Cuaderno Interactivo: Clase 01: Análisis de Complejidad y Notación Big-O

> **Curso:** 02-algoritmos-estructuras  
> **Archivo:** [`clase-01-analisis-complejidad-big-o.ipynb`](clase-01-analisis-complejidad-big-o.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-01-analisis-complejidad-big-o.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-01-analisis-complejidad-big-o.ipynb`](clase-01-analisis-complejidad-big-o.ipynb) directamente en Visual Studio Code.
