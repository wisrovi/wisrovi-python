...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Constante O1)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 02-algoritmos-estructuras/clase-01-analisis-complejidad-big-o/ejemplos/ejemplo_01_constante_o1/main.py
```
