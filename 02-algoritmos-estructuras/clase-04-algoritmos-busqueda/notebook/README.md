# 📓 Cuaderno Interactivo: Clase 04: Algoritmos de Búsqueda: Lineal vs Binaria O(log n)

> **Curso:** 02-algoritmos-estructuras  
> **Archivo:** [`clase-04-algoritmos-busqueda.ipynb`](clase-04-algoritmos-busqueda.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-04-algoritmos-busqueda.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-04-algoritmos-busqueda.ipynb`](clase-04-algoritmos-busqueda.ipynb) directamente en Visual Studio Code.
