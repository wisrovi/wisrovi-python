...
> **Ubicación:** `02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_03_modulo_bisect`  
...
```bash
python 02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_03_modulo_bisect/main.py
```
