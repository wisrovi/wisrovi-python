...
> **Ubicación:** `02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_04_busqueda_rotada`  
...
```bash
python 02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_04_busqueda_rotada/main.py
```
