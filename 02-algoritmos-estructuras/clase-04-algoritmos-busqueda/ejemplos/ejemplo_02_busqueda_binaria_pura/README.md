# 📖 02 Busqueda Binaria Pura

> **Clase:** Clase 04: Algoritmos de Búsqueda: Lineal vs Binaria O(log n)  
> **Ubicación:** `02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_02_busqueda_binaria_pura`  
...
```bash
python 02-algoritmos-estructuras/clase-04-algoritmos-busqueda/ejemplos/ejemplo_02_busqueda_binaria_pura/main.py
```
