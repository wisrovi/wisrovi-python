# 🏋️ Reto Práctico: Clase 04: Algoritmos de Búsqueda: Lineal vs Binaria O(log n)

<div align="center">

**Curso 2: Algoritmos Avanzados y Estructuras de Datos** &bull; **Semana CLASE 04**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_02/test_clase_04_algoritmos_busqueda.py`](../../tests/curso_02/test_clase_04_algoritmos_busqueda.py)
