# 📓 Cuaderno Interactivo: Clase 04: Control de Flujo: Bucles (for / while)

> **Curso:** 01-fundamentos-python  
> **Archivo:** [`clase-04-control-flujo-bucles.ipynb`](clase-04-control-flujo-bucles.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-04-control-flujo-bucles.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-04-control-flujo-bucles.ipynb`](clase-04-control-flujo-bucles.ipynb) directamente en Visual Studio Code.
