...
> **Ubicación:** `01-fundamentos-python/clase-04-control-flujo-bucles/ejemplos/ejemplo_03_while_acumulador`  
...
```bash
python 01-fundamentos-python/clase-04-control-flujo-bucles/ejemplos/ejemplo_03_while_acumulador/main.py
```
