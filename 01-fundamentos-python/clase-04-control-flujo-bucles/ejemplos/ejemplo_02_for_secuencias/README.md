...
> **Ubicación:** `01-fundamentos-python/clase-04-control-flujo-bucles/ejemplos/ejemplo_02_for_secuencias`  
...
```bash
python 01-fundamentos-python/clase-04-control-flujo-bucles/ejemplos/ejemplo_02_for_secuencias/main.py
```
