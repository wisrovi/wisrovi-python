# 📁 01-Fundamentos-Python ➔ Recursos

> **Ubicación en Repositorio:** `01-fundamentos-python/recursos`  
...
```mermaid
flowchart LR
    COMP["📦 Componente<br/>recursos"] --> SYS["⚙️ Sistema wisrovi-python<br/>Infraestructura & Recursos"]
