...
> **Ubicación:** `01-fundamentos-python/clase-05-listas-y-colecciones/ejemplos/ejemplo_04_list_comprehension`  
...
```bash
python 01-fundamentos-python/clase-05-listas-y-colecciones/ejemplos/ejemplo_04_list_comprehension/main.py
```
