...
Ejemplo 02: Slicing de Listas [inicio:fin:paso].
...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Slicing Rebanadas)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 01-fundamentos-python/clase-05-listas-y-colecciones/ejemplos/ejemplo_02_slicing_rebanadas/main.py
```
