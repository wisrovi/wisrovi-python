# 🏋️ Reto Práctico: Clase 05: Listas, Tuplas y Colecciones Básicas

<div align="center">

**Curso 1: Fundamentos Básicos de Python** &bull; **Semana CLASE 05**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_05_listas_y_colecciones.py`](../../tests/curso_01/test_clase_05_listas_y_colecciones.py)
