# 📓 Cuaderno Interactivo: Clase 05: Listas, Tuplas y Colecciones Básicas

> **Curso:** 01-fundamentos-python  
> **Archivo:** [`clase-05-listas-y-colecciones.ipynb`](clase-05-listas-y-colecciones.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-05-listas-y-colecciones.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-05-listas-y-colecciones.ipynb`](clase-05-listas-y-colecciones.ipynb) directamente en Visual Studio Code.
