# 📓 Cuaderno Interactivo: Clase 03: Control de Flujo: Condicionales (if / elif / else)

> **Curso:** 01-fundamentos-python  
> **Archivo:** [`clase-03-control-flujo-condicionales.ipynb`](clase-03-control-flujo-condicionales.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 clase-03-control-flujo-condicionales.ipynb"] --> COLAB["☁️ Google Colab<br/>(1 Clic)"]
...
*   **En Local:** Abre [`clase-03-control-flujo-condicionales.ipynb`](clase-03-control-flujo-condicionales.ipynb) directamente en Visual Studio Code.
