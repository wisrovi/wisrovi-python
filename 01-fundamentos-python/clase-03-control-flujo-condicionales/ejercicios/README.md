# 🏋️ Reto Práctico: Clase 03: Control de Flujo: Condicionales (if / elif / else)

<div align="center">

**Curso 1: Fundamentos Básicos de Python** &bull; **Semana CLASE 03**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_03_control_flujo_condicionales.py`](../../tests/curso_01/test_clase_03_control_flujo_condicionales.py)
