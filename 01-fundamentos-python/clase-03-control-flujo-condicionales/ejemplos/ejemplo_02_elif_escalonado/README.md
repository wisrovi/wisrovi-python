...
> **Ubicación:** `01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_02_elif_escalonado`  
...
```bash
python 01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_02_elif_escalonado/main.py
```
