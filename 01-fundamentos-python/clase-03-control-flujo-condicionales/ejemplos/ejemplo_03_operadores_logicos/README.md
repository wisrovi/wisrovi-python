...
> **Ubicación:** `01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_03_operadores_logicos`  
...
```bash
python 01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_03_operadores_logicos/main.py
```
