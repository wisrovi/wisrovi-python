# 📖 04 Operador Ternario

> **Clase:** Clase 03: Control de Flujo: Condicionales (if / elif / else)  
> **Ubicación:** `01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_04_operador_ternario`  
...
```bash
python 01-fundamentos-python/clase-03-control-flujo-condicionales/ejemplos/ejemplo_04_operador_ternario/main.py
```
