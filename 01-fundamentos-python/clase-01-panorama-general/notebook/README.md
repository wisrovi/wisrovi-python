# 📓 Cuaderno Interactivo: Clase 01: Primer Vistazo Práctico (print, variables, if, for)

> **Curso:** 01-fundamentos-python  
> **Archivo:** [`clase-01-panorama-general.ipynb`](clase-01-panorama-general.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 clase-01-panorama-general.ipynb"] --> COLAB["☁️ Google Colab<br/>(1 Clic)"]
...
*   **En Local:** Abre [`clase-01-panorama-general.ipynb`](clase-01-panorama-general.ipynb) directamente en Visual Studio Code.
