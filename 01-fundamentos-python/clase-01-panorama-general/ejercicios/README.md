...
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_01_panorama_general.py`](../../tests/curso_01/test_clase_01_panorama_general.py)
