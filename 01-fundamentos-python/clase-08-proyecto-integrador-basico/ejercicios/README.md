...
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_08_proyecto_integrador_basico.py`](../../tests/curso_01/test_clase_08_proyecto_integrador_basico.py)
