...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Crud Diccionarios)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 01-fundamentos-python/clase-06-diccionarios/ejemplos/ejemplo_01_crud_diccionarios/main.py
```
