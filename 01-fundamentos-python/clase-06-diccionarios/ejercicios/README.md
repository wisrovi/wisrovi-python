# 🏋️ Reto Práctico: Clase 06: Diccionarios y Conjuntos (Sets)

<div align="center">

**Curso 1: Fundamentos Básicos de Python** &bull; **Semana CLASE 06**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_06_diccionarios.py`](../../tests/curso_01/test_clase_06_diccionarios.py)
