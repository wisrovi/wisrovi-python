# 🏋️ Reto Práctico: Clase 07: Funciones, Parámetros y Scope

<div align="center">

**Curso 1: Fundamentos Básicos de Python** &bull; **Semana CLASE 07**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_01/test_clase_07_funciones.py`](../../tests/curso_01/test_clase_07_funciones.py)
