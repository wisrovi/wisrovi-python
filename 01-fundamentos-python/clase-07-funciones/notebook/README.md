# 📓 Cuaderno Interactivo: Clase 07: Funciones, Parámetros y Scope

> **Curso:** 01-fundamentos-python  
> **Archivo:** [`clase-07-funciones.ipynb`](clase-07-funciones.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-07-funciones.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-07-funciones.ipynb`](clase-07-funciones.ipynb) directamente en Visual Studio Code.
