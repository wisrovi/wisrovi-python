...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(03 Scope Legb)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 01-fundamentos-python/clase-07-funciones/ejemplos/ejemplo_03_scope_legb/main.py
```
