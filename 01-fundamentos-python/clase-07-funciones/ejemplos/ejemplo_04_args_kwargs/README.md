...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Args Kwargs)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 01-fundamentos-python/clase-07-funciones/ejemplos/ejemplo_04_args_kwargs/main.py
```
