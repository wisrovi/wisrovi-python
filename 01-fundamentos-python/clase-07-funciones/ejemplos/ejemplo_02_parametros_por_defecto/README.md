...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Parametros Por Defecto)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 01-fundamentos-python/clase-07-funciones/ejemplos/ejemplo_02_parametros_por_defecto/main.py
```
