# 📖 04 Captura Validation Error

> **Clase:** Clase 03: Salidas Estructuradas y Validación Tipada con Pydantic V2  
> **Ubicación:** `03-agentes-ia/clase-03-salidas-estructuradas-pydantic/ejemplos/ejemplo_04_captura_validation_error`  
...
```bash
python 03-agentes-ia/clase-03-salidas-estructuradas-pydantic/ejemplos/ejemplo_04_captura_validation_error/main.py
```
