# 📖 02 Field Restricciones

> **Clase:** Clase 03: Salidas Estructuradas y Validación Tipada con Pydantic V2  
> **Ubicación:** `03-agentes-ia/clase-03-salidas-estructuradas-pydantic/ejemplos/ejemplo_02_field_restricciones`  
...
```bash
python 03-agentes-ia/clase-03-salidas-estructuradas-pydantic/ejemplos/ejemplo_02_field_restricciones/main.py
```
