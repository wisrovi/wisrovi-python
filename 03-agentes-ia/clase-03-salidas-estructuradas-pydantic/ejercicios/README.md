# 🏋️ Reto Práctico: Clase 03: Salidas Estructuradas y Validación Tipada con Pydantic V2

<div align="center">

**Curso 3: Creación y Desarrollo de Agentes de IA** &bull; **Semana CLASE 03**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_03/test_clase_03_salidas_estructuradas_pydantic.py`](../../tests/curso_03/test_clase_03_salidas_estructuradas_pydantic.py)
