# 🏋️ Reto Práctico: Clase 01: Fundamentos de LLMs, Tokens y Arquitectura Transformer

<div align="center">

**Curso 3: Creación y Desarrollo de Agentes de IA** &bull; **Semana CLASE 01**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_03/test_clase_01_fundamentos_llm_tokenizacion.py`](../../tests/curso_03/test_clase_01_fundamentos_llm_tokenizacion.py)
