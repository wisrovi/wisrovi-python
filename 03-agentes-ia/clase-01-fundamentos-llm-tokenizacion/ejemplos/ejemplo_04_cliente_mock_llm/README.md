...
Demostración técnica de Cliente de Inferencia Simulado.

## 💻 Cómo Ejecutar este Ejemplo
Desde la terminal de VS Code en la raíz del repositorio, ejecuta:
```bash
python 03-agentes-ia/clase-01-fundamentos-llm-tokenizacion/ejemplos/ejemplo_04_cliente_mock_llm/main.py
```
