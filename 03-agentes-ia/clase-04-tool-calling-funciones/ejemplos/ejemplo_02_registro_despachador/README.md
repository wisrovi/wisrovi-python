...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Registro Despachador)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-04-tool-calling-funciones/ejemplos/ejemplo_02_registro_despachador/main.py
```
