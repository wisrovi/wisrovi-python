...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(03 Despacho Kwargs)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-04-tool-calling-funciones/ejemplos/ejemplo_03_despacho_kwargs/main.py
```
