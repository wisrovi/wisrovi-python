...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Herramienta Clima Mock)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-04-tool-calling-funciones/ejemplos/ejemplo_04_herramienta_clima_mock/main.py
```
