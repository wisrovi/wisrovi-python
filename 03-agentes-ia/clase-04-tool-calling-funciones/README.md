...
> **Nivel:** Nivel 3 - Avanzado &bull; **Metáfora:** *«Dotando de Manos y Herramientas al Cerebro del LLM»*  
...
*   📄 [`clase-04-tool-calling-funciones.pdf`](clase-04-tool-calling-funciones.pdf): Manual técnico oficial en PDF (9 páginas).
