# 🏋️ Reto Práctico: Clase 04: Tool Calling y Function Calling en Python

<div align="center">

**Curso 3: Creación y Desarrollo de Agentes de IA** &bull; **Semana CLASE 04**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_03/test_clase_04_tool_calling_funciones.py`](../../tests/curso_03/test_clase_04_tool_calling_funciones.py)
