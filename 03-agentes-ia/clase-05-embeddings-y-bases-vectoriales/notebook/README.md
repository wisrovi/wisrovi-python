# 📓 Cuaderno Interactivo: Clase 05: Embeddings y Representación Vectorial Semántica

> **Curso:** 03-agentes-ia  
> **Archivo:** [`clase-05-embeddings-y-bases-vectoriales.ipynb`](clase-05-embeddings-y-bases-vectoriales.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-05-embeddings-y-bases-vectoriales.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-05-embeddings-y-bases-vectoriales.ipynb`](clase-05-embeddings-y-bases-vectoriales.ipynb) directamente en Visual Studio Code.
