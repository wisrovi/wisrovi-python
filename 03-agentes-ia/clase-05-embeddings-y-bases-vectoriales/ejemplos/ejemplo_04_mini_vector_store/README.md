# 📖 04 Mini Vector Store

> **Clase:** Clase 05: Embeddings y Representación Vectorial Semántica  
> **Ubicación:** `03-agentes-ia/clase-05-embeddings-y-bases-vectoriales/ejemplos/ejemplo_04_mini_vector_store`  
...
```bash
python 03-agentes-ia/clase-05-embeddings-y-bases-vectoriales/ejemplos/ejemplo_04_mini_vector_store/main.py
```
