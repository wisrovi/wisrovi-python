...
> **Ubicación:** `03-agentes-ia/clase-05-embeddings-y-bases-vectoriales/ejemplos/ejemplo_02_similitud_coseno`  
...
```bash
python 03-agentes-ia/clase-05-embeddings-y-bases-vectoriales/ejemplos/ejemplo_02_similitud_coseno/main.py
```
