...
Agente Investigador y Redactor.
...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Agentes Especialistas)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-08-sistemas-multi-agente/ejemplos/ejemplo_01_agentes_especialistas/main.py
```
