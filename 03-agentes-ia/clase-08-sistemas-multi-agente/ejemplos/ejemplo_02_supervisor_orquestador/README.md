...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Supervisor Orquestador)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-08-sistemas-multi-agente/ejemplos/ejemplo_02_supervisor_orquestador/main.py
```
