...
**Curso 3: Creación y Desarrollo de Agentes de IA** &bull; **Semana CLASE 08**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_03/test_clase_08_sistemas_multi_agente.py`](../../tests/curso_03/test_clase_08_sistemas_multi_agente.py)
