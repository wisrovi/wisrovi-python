...
Delimitadores de Seguridad XML.
...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Delimitadores Xml)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-02-prompt-engineering-avanzado/ejemplos/ejemplo_04_delimitadores_xml/main.py
```
