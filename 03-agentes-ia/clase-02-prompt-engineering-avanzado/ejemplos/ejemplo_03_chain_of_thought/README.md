...
> **Ubicación:** `03-agentes-ia/clase-02-prompt-engineering-avanzado/ejemplos/ejemplo_03_chain_of_thought`  
...
```bash
python 03-agentes-ia/clase-02-prompt-engineering-avanzado/ejemplos/ejemplo_03_chain_of_thought/main.py
```
