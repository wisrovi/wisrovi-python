# 📖 03 Prompt Aumentado Rag

<div align="center">

**Clase:** Clase 06: Arquitecturas RAG (Retrieval-Augmented Generation)  
...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(03 Prompt Aumentado Rag)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-06-arquitecturas-rag/ejemplos/ejemplo_03_prompt_aumentado_rag/main.py
```
