...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Chunking Overlap)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-06-arquitecturas-rag/ejemplos/ejemplo_01_chunking_overlap/main.py
```
