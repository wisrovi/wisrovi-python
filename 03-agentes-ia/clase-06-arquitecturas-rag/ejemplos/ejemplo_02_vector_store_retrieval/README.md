...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Vector Store Retrieval)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-06-arquitecturas-rag/ejemplos/ejemplo_02_vector_store_retrieval/main.py
```
