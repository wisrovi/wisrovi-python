...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(04 Guardrail Fuentes)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-06-arquitecturas-rag/ejemplos/ejemplo_04_guardrail_fuentes/main.py
```
