...
> **Curso:** Curso 3: Creación y Desarrollo de Agentes de IA (CLASE 06)  
...
1. **💡 Modelo Mental:** En lugar de pedirle al alumno que responda de memoria, le permites consultar el capítulo exacto del libro antes de contestar.
...
```mermaid
flowchart LR
    M["💡 1. Modelo Mental<br/>«RAG como Darle al LLM un Libro...»"] --> E["💻 2. Ejemplos Prácticos<br/>4 carpetas ejecutables"]
...
flowchart LR
    ...
    subgraph Core["🧠 Núcleo del Sistema"]
        ENG["Motor de Ejecución (Arquitecturas RAG (Retrieval-Augmented Generation))"]
...
*   📄 [`clase-06-arquitecturas-rag.pdf`](clase-06-arquitecturas-rag.pdf): Manual técnico oficial en PDF (9 páginas de estudio).
