# 🏋️ Reto Práctico: Clase 06: Arquitecturas RAG (Retrieval-Augmented Generation)

<div align="center">

**Curso 3: Creación y Desarrollo de Agentes de IA** &bull; **Semana CLASE 06**  
*Archivo de Trabajo:* [`reto.py`](reto.py) &bull; *Suite de Validación:* [`tests/curso_03/test_clase_06_arquitecturas_rag.py`](../../tests/curso_03/test_clase_06_arquitecturas_rag.py)
