# 📓 Cuaderno Interactivo: Clase 06: Arquitecturas RAG (Retrieval-Augmented Generation)

> **Curso:** 03-agentes-ia  
> **Archivo:** [`clase-06-arquitecturas-rag.ipynb`](clase-06-arquitecturas-rag.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-06-arquitecturas-rag.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-06-arquitecturas-rag.ipynb`](clase-06-arquitecturas-rag.ipynb) directamente en Visual Studio Code.
