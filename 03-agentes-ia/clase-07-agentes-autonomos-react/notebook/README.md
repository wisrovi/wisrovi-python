# 📓 Cuaderno Interactivo: Clase 07: Agentes Autónomos y el Ciclo Cognitivo ReAct

> **Curso:** 03-agentes-ia  
> **Archivo:** [`clase-07-agentes-autonomos-react.ipynb`](clase-07-agentes-autonomos-react.ipynb)  
...
```mermaid
flowchart LR
    NB["📓 Cuaderno Jupyter<br/>(clase-07-agentes-autonomos-react.ipynb)"] --> COLAB["☁️ Ejecución Nube<br/>Google Colab (1 clic)"]
...
*   **En Local:** Abre [`clase-07-agentes-autonomos-react.ipynb`](clase-07-agentes-autonomos-react.ipynb) directamente en Visual Studio Code.
