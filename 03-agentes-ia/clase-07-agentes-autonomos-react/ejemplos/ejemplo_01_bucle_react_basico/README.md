...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(01 Bucle React Basico)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-07-agentes-autonomos-react/ejemplos/ejemplo_01_bucle_react_basico/main.py
```
