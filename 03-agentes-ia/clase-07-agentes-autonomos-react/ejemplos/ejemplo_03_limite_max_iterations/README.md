# 📖 03 Limite Max Iterations

> **Clase:** Clase 07: Agentes Autónomos y el Ciclo Cognitivo ReAct  
> **Ubicación:** `03-agentes-ia/clase-07-agentes-autonomos-react/ejemplos/ejemplo_03_limite_max_iterations`  
...
```bash
python 03-agentes-ia/clase-07-agentes-autonomos-react/ejemplos/ejemplo_03_limite_max_iterations/main.py
```
