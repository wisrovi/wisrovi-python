...
```mermaid
flowchart LR
    A["📥 Entrada de Parámetros<br/>(02 Agente Con Herramientas)"] --> B["⚙️ Transformación Lógica<br/>Ejecución en Python"]
...
```bash
python 03-agentes-ia/clase-07-agentes-autonomos-react/ejemplos/ejemplo_02_agente_con_herramientas/main.py
```
